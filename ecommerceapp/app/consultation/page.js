      ...
      <div className='w-1/2 m-auto mt-4 p-6 border'>
        ...
        <div className='p-2'>
          ...
          <div className='grid grid-cols-2 gap-4 p-2'>
            ...
            <div className='border grid grid-cols-3 hover:border-2 hover:border-teal-500' onClick={() => setRing('Engagement Ring')}>
            ...
            <div className='border grid grid-cols-3 hover:border-2 hover:border-teal-500' onClick={() => setRing('Wedding Ring')}>
            ...
            <div className='border grid grid-cols-3 hover:border-2 hover:border-teal-500' onClick={() => setRing('Fine Jewelry & Gifts')}>
            ...
            <div className='border grid grid-cols-3 hover:border-2 hover:border-teal-500' onClick={() => setRing('Divorce Ring')}>
        ...
        <div className='grid grid-cols-2 gap-4 font-serif'>
          ...
          <div className=' grid grid-cols-3 gap-4'>
              <button onClick={(e) => {setSelectedTime(e.target.value); setClickedTime(1);}} value='08:00 AM'  className={`border-2 p-2 hover:border-teal-500 ${clickedTime === 1 ? 'border-teal-500' : '' }`} >08:00 AM</button>
              <button onClick={(e) => {setSelectedTime(e.target.value); setClickedTime(2);}} value='09:00 AM'  className={`border-2 p-2 hover:border-teal-500 ${clickedTime === 2 ? 'border-teal-500' : '' }`} >09:00 AM</button>
              <button onClick={(e) => {setSelectedTime(e.target.value); setClickedTime(3);}} value='10:00 AM'  className={`border-2 p-2 hover:border-teal-500 ${clickedTime === 3 ? 'border-teal-500' : '' }`} >10:00 AM</button>  
              <button onClick={(e) => {setSelectedTime(e.target.value); setClickedTime(4);}} value='11:00 AM'  className={`border-2 p-2 hover:border-teal-500 ${clickedTime === 4 ? 'border-teal-500' : '' }`} >11:00 AM</button>
              <button onClick={(e) => {setSelectedTime(e.target.value); setClickedTime(5);}} value='12:00 PM'  className={`border-2 p-2 hover:border-teal-500 ${clickedTime === 5 ? 'border-teal-500' : '' }`} >12:00 AM</button>
              <button onClick={(e) => {setSelectedTime(e.target.value); setClickedTime(6);}} value='01:00 PM'  className={`border-2 p-2 hover:border-teal-500 ${clickedTime === 6 ? 'border-teal-500' : '' }`} >01:00 PM</button>
              <button onClick={(e) => {setSelectedTime(e.target.value); setClickedTime(7);}} value='02:00 PM'  className={`border-2 p-2 hover:border-teal-500 ${clickedTime === 7 ? 'border-teal-500' : '' }`} >02:00 PM</button>
              <button onClick={(e) => {setSelectedTime(e.target.value); setClickedTime(8);}} value='03:00 PM'  className={`border-2 p-2 hover:border-teal-500 ${clickedTime === 8 ? 'border-teal-500' : '' }`} >03:00 PM</button>
              <button onClick={(e) => {setSelectedTime(e.target.value); setClickedTime(9);}} value='04:00 PM'  className={`border-2 p-2 hover:border-teal-500 ${clickedTime === 9 ? 'border-teal-500' : '' }`}>04:00 PM</button>
          </div>
          ...
          <div>
            ...
            <div className='grid grid-cols-2'>
              ...
              <div className="flex justify-center items-center my-2 bg-[url('/assets/appoint-bg.jpg')] bg-cover w-full h-[372px]">
                  ...
                  <p className='text-sm'>{ value===null ?'': value.$d}</p>
                  </div>
              </div>
