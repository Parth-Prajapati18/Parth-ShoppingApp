...
const ProductDetail = ({ params }) => {
  ...
  const { wishList, addToWishList, removeToWishList, addToCart, removeToCart, cartAry, products } = useContext(globalContext);
      ...
      <div className='flex flex-col lg:flex-row space-y-4 md:space-y-0 md:space-x-4 md:ml-24 lg:gap-10 mx-4 md:mx-16'>
        ...
        <div className='lg:w-1/4 pt-4 md:pt-8 mx-4 md:mx-8 xl:mx-16 '>
          ...
          <div className='flex flex-col gap-2 mt-8'>
            <span className='px-4 py-2 bg-white font-semibold border border-black text-center'>$ {JSON.parse(product.price).toFixed(2)}</span>
            {
